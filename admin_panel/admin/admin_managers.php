											...
											<table class="table table-hover">
												...
												<tbody>
													...
													while ($row = mysqli_fetch_assoc($result)) { ?>
														...
														<tr>
															<td><img src="../../images/managers/<?php echo $row['manager_image']; ?>" class="round_img"
															...
															<td id="username_<?php echo $row['manager_id'] ?>"><?php echo $row['manager_username']; ?>
															</td>
															<td id="password_<?php echo $row['manager_id'] ?>"><?php echo $row['manager_password']; ?>
															</td>
