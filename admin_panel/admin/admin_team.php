                    ...
                    <div class="card-content table-responsive">
                      <table class="table table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td><img src="../../images/team/<?php echo $row['member_image']; ?>" class="round_img"
                            ...
                            <td id="salary_<?php echo $row['member_id'] ?>">Rp <?php echo $row['member_salary']; ?>
                            </td>
                            <td id="username_<?php echo $row['member_id'] ?>"><?php echo $row['member_username']; ?>
                            </td>
                            <td id="password_<?php echo $row['member_id'] ?>"><?php echo $row['member_password']; ?>
                            </td>
            ...
            <div id="content_2" class="content">
              ...
              <form action="" method="post" enctype="multipart/form-data">
                <table width="220" height="106" border="0">
                  ...
                  <tr>
                    <td align="center"><input name="name" type="text" style="width:100%" placeholder="Member Name"
                        required="required" id="add_member_name" /></td>
                  </tr>
                  <tr>
                    <td align="center"><input name="role" type="text" style="width:100%" placeholder="Role"
                        required="required" id="add_member_role" /></td>
                  </tr>
                  <tr>
                    <td align="center"><input name="phone" type="text" style="width:100%" placeholder="Phone Number"
                        required="required" id="add_member_phone" /></td>
                  </tr>
                  <tr>
                    <td align="center"><input name="email" type="email" style="width:100%" placeholder="Email"
                        required="required" id="add_member_email" /></td>
                  </tr>
                  <tr>
                    <td align="center"><input name="salary" type="text" style="width:100%" placeholder="Salary"
                        required="required" id="add_member_salary" /></td>
                  </tr>
                  <tr>
                    <td align="center"><input name="username" type="text" style="width:100%" placeholder="Username"
                        required="required" id="add_member_username" /></td>
                  </tr>
                  <tr>
                    <td align="center"><input name="password" type="text" style="width:100%" placeholder="Password"
                        required="required" id="add_member_password" /></td>
                  </tr>
                  <tr>
