														...
														<tr>
															...
															<td>
																<button class="update_manager" id="<?php echo $row['manager_id'] ?>">
																	<span class="iconify" data-icon="bx:edit" style="color: green;" data-width="30" data-height="30" maxlength="15"></span>
																</button>
															</td>
															<td>
																<button class="delete_manager" id="<?php echo $row['manager_id'] ?>">
																	<span class="iconify" data-icon="fluent:delete-24-filled" style="color: red;" data-width="30" data-height="30" maxlength="15"></span>
																</button>
															</td>
														<?php } ?>
												</tbody>
