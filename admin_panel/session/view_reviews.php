    ...
    <div id="content">
      ...
      <div class="main-content">
        ...
        <div class="reviews_stat">
          <?php
          // Get the number of people who rated in a specific month and the number of stars
          ...
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            if ($monthValue >= 1 && $monthValue <= 12) {
              $month_array[$monthValue - 1]++;
              $average_rating_month_array[$monthValue - 1] += $starValue;
            }

            if ($starValue >= 1 && $starValue <= 5) {
              $star_array[$starValue - 1]++;
            }
          }
