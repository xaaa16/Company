...
menuTabs.addEventListener("click", function (e) {
  if (
    ...
    menuSection
      .querySelectorAll(".menu-tab-content.show")
      .forEach(function (e) {
...
// Function untuk memunculkan loader saat halaman dimuat
function showLoader() {
  document.querySelector(".loader-container").classList.remove("fade-out");
}

// Function untuk menyembunyikan loader dengan efek fade-out
function hideLoader() {
  document.querySelector(".loader-container").classList.add("fade-out");
}

// Function untuk kembali ke menu paling atas dan sembunyikan loader
function returnToTop() {
  hideLoader(); // Sembunyikan loader saat kembali ke menu paling atas
  // Tambahkan kode untuk scroll ke bagian atas halaman atau navigasi ke halaman utama
  return false; // Untuk memastikan link tidak mengarahkan ke halaman lain
}

// Function untuk memanggil hideLoader setelah beberapa detik
function fadeOutLoader() {
  setTimeout(hideLoader, 4000); // Ubah interval menjadi setTimeout agar hanya sekali
}

// Event listener saat halaman selesai dimuat
window.onload = function () {
  showLoader(); // Memunculkan loader saat halaman dimuat
  fadeOutLoader(); // Memanggil fungsi untuk menyembunyikan loader setelah beberapa detik
};
